      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          if (!snapshot.hasData) {
            return const Center(
                child:
                    CircularProgressIndicator(color: TshikotaTheme.royalRed));
          }
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () => _toggleAvailability(
                              itemId, item['isAvailable'] == true),
                          tooltip: 'Toggle availability',
                        ),
                        // Edit
                        IconButton(
                          icon: const Icon(Icons.edit_outlined,
                              color: TshikotaTheme.royalRed, size: 22),
                        ...
                        IconButton(
                          icon: const Icon(Icons.delete_outline,
                              color: TshikotaTheme.error, size: 22),
                          onPressed: () =>
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            style:
                ElevatedButton.styleFrom(backgroundColor: TshikotaTheme.error),
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: const [
                        ...
                        DropdownMenuItem(
                            value: 'Fruit Box', child: Text('Fruit Box')),
                        DropdownMenuItem(
                            value: 'Veggie Box', child: Text('Veggie Box')),
                        ...
                        onPressed: isLoading
                            ...
                            : () async {
                                if (nameCtrl.text.trim().isEmpty ||
                                  ...
                                  _showSnack('Name and price are required',
                                      isError: true);
                                  return;
                                }
